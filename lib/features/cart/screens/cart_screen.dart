    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Thumbnail Image - Fixed size, responsive
            ClipRRect(
            ...
            SizedBox(width: MediaQuery.of(context).size.width * 0.03), // Responsive spacing

            // Item Details - Flexible to take remaining space
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                ...
                children: [
                  ...
                  // Price - Wrap in Flexible to prevent overflow
                  Wrap(
            ...
            // Quantity Stepper and Total - Fixed width, no overflow
            Column(
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // Subtotal Row - Use Flexible to prevent overflow
              Row(
              ...
              // Total Savings Row (Highlighted in Green) - Responsive layout
              Container(
              ...
              // Proceed to Checkout Button (Full Width) - Responsive padding
              SizedBox(
