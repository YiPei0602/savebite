    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          if (_paymentMethods.isEmpty)
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text('No saved cards', style: AppTypography.h5),
          ...
          Text('Other Payment Options', style: AppTypography.h5),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(method['brand'], style: AppTypography.h5),
  ...
  void _deleteCard(Map<String, dynamic> method) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content:
            Text('Remove ${method['brand']} ending in ${method['last4']}?'),
        actions: [
          TextButton(
