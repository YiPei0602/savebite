      ...
      flexibleSpace: FlexibleSpaceBar(
        background: Stack(
          ...
          children: [
            // Cover Image
            Image.network(
              widget.imageUrl ?? 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800',
              fit: BoxFit.cover,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Restaurant Name
            Text(
              widget.merchantName ?? 'Merchant ${widget.merchantId}',
              ...
              onPressed: () {
                ...
                _cart.forEach((itemId, quantity) {
                  ...
                  cartItems[itemId] = {
                    ...item,
                    'quantity': quantity,
                    'merchantName': widget.merchantName ?? 'Merchant ${widget.merchantId}',
