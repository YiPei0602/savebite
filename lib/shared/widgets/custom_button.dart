      ...
      case ButtonVariant.secondary:
        button = OutlinedButton(
          ...
          style: OutlinedButton.styleFrom(
            foregroundColor: customColor ?? AppColors.buttonPrimary,
            side: BorderSide(
              color: customColor ?? AppColors.buttonPrimary,
              width: 1.5,
            ),
            minimumSize: Size(0, buttonHeight),
            padding: buttonPadding,
    ...
    switch (size) {
      case ButtonSize.small:
        return AppTypography.buttonSmall.copyWith(
          color:
              variant == ButtonVariant.primary || variant == ButtonVariant.accent
                  ? AppColors.textOnPrimary
                  : customColor ?? AppColors.buttonPrimary,
        );
      case ButtonSize.medium:
